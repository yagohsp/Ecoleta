    ...
    return (
        <ImageBackground source={require('../../assets/home-background.png')} style={styles.container} imageStyle={{ width: 274, height: 368 }}>
            ...
            <View style={styles.footer}>
                <TextInput style={styles.input} placeholder="Digite a UF" onChangeText={setUf}></TextInput>
                <TextInput style={styles.input} placeholder="Digite a Cidade" onChangeText={setCity}></TextInput>
